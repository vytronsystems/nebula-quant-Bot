...
export default function OperatorPage() {
  return (
    <div className="space-y-6">
      <p className="text-gray-400">Operator Cockpit. Use the cards below to open each screen; data will load when the control plane APIs are connected.</p>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/operator/promotion-queue"><Card className="hover:border-nebula-cyan/50"><CardHeader><CardTitle>Promotion Queue</CardTitle></CardHeader><CardContent>Approve promote to live / paper / backtest</CardContent></Card></Link>
